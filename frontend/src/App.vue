...
<template>
  ...
  <div v-else class="app-shell">
    ...
    <main class="main-area">
      ...
      <div class="data-version-strip"><strong>VM · V 0.003</strong> · Company VM (Django + MySQL) · Audit Log recording enabled<br><small>Case forms: use Save draft / Save changes / Review &amp; Confirm. SOA settlement, Dashboard and document generation are still being migrated.</small></div>
